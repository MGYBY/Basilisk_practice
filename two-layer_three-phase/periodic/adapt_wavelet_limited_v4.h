/**
 T *his is written by *César Pairetti*, and is available [(here)](http://basilisk.fr/sandbox/pairetti/bag_mode/adapt_wavelet_limited.h). I keep it in the same folder for completeness.
