...
#endif
#ifndef WAVE_LENGTH
#define WAVE_LENGTH (12.0/THIXO_SO)
#endif
#ifndef TOP_HEIGHT
...
#endif
#ifndef OUTPUT_DT
#define OUTPUT_DT (0.25/THIXO_SO)
#endif
#ifndef MAXTIME
#define MAXTIME (132.0/THIXO_SO)
#endif
#ifndef PROFILE_FILE
...
event output_gfs_files (t += OUTPUT_DT)
{
  ...
  output_gfs (fp, translate = true,
              list = {f, lambda_thixo, lambda_plot, flambda, gammadot_thixo,
...
event adapt (i++) {
  ...
  adapt_wavelet_limited ((scalar *){ omega, velFluidNorm, velAirNorm, gltn}, {f}, (double[]){ OMEGA_ERR, UFLUID_ERR, UAIR_ERR, 1.e-2}, refRegion, minlevel = MINLEVEL);
  refine(y<=(5.550*WAVE_LENGTH/pow(2, MAXLEVEL)) && level<MAXLEVEL);
