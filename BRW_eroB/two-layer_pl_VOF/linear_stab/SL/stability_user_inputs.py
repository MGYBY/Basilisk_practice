...
BASE_PARAMETERS = Parameters(
    froude=0.6,                    # lower-layer Froude number Fr_l
    depth_ratio=1.0,               # h_r = H_u/H_l
    density_ratio=1.0,             # r_rho = rho_u/rho_l
    n_lower=1.0,                   # lower-layer power-law index n_l
    n_upper=1.0,                   # upper-layer power-law index n_u
    scaled_consistency_ratio=1.0,  # kappa_K = Lambda_u/Lambda_l
)

# A short label used to name the output directory.
CASE_NAME = "rhoRSweep-frc_rRho1_nL1_nU1_kK1"
# CASE_NAME = "eigenstructure_frl0p6_hr1_rRho1_nL1_nU1_kK1"
...
# SWEEP_VALUES = np.linspace(0.1, 10.0, 46)
# SWEEP_PARAMETER = "n_lower"
# SWEEP_VALUES = np.linspace(0.1, 1.0, 46)
SWEEP_PARAMETER = "density_ratio"
SWEEP_VALUES = np.linspace(0.5, 2.0, 31)
...
WAVENUMBER_MIN = 1.0e-3
WAVENUMBER_MAX = 1.0e1
