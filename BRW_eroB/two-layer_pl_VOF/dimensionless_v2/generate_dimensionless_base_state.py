...
def load_case(path: Path) -> Case:
    ...
    case = Case(
        ...
        filter_vof_properties=_required_bool(
            parser, "numerical_options", "filtered"
        ),
...
def write_generated_header(path: Path, c: Case, base: dict) -> None:
    ...
    entries: list[tuple[str, str]] = [
        ...
        ("CASE_FILTERED", c_bool(c.filter_vof_properties)),
...
Numerical material treatment
----------------------------
FILTERED                = {int(c.filter_vof_properties)}
